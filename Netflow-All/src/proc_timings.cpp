...
int main()
{
  ...
  printf("newgraph\n");
  printf("xaxis size 6 min 0 max 375 hash_labels fontsize 12 hash 50 mhash 4\n");
  printf("  label fontsize 14 : Interior Nodes\n");
  printf("yaxis size 3 min 0 max 1 hash_labels fontsize 12\n");
  printf("label fontsize 14 : Average time (s)\n");
  printf("title fontsize 16 : Speed of Network Flow Algorithms\n");
