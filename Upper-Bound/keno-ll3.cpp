...
class Keno_LL {
  public:
    ...
    void Calculate_All();          /* This is new -- calculate for all balls, rather than
                                      for one random ball. */
};
...
/* The implementation for now is really simple.  
   We'll make it better in our next iteration. */
